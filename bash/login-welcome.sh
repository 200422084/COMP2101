...
#comand to store the day of the week and the time displaying message to a variable.
messagevar="It is $dayvar at $timevar"
...
#command to store the welcome message into a variable.
welcomevar="Welcome to planet $(hostname) $title $uservar!"

#command to display the output of the variables using the cowsay command"
cowsay "$messagevar , $welcomevar"
